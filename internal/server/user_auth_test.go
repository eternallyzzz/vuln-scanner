...
func TestUserCanMatrix(t *testing.T) {
	cases := []struct {
		...
		{"admin", http.MethodGet, "/api/v1/compliance/summary", true},
		{"viewer", http.MethodGet, "/api/v1/compliance/agents", true},
		{"viewer", http.MethodGet, "/api/v1/compliance/agents/agent-1", true},
		{"operator", http.MethodGet, "/api/v1/compliance/export.csv", true},
		{"operator", http.MethodPost, "/api/v1/compliance/summary", false},
		{"viewer", http.MethodPost, "/api/v1/compliance/agents", false},
		...
		{"operator", http.MethodPost, "/api/v1/patch-tasks/1/stop", true},
		{"viewer", http.MethodPost, "/api/v1/patch-tasks/1/stop", false},
		{"viewer", http.MethodGet, "/api/v1/patch-tasks/1/events", true},
		{"operator", http.MethodGet, "/api/v1/patch-tasks/1/events", true},
		...
		{"operator", http.MethodPost, "/api/v1/network/scan", true},
		{"viewer", http.MethodPost, "/api/v1/network/scan", false},
		{"viewer", http.MethodGet, "/api/v1/network/hosts", true},
		{"operator", http.MethodGet, "/api/v1/network/tasks", true},
		{"operator", http.MethodPost, "/api/v1/remote/scan", true},
		{"viewer", http.MethodPost, "/api/v1/remote/scan", false},
		{"viewer", http.MethodGet, "/api/v1/remote/hosts", true},
		{"operator", http.MethodGet, "/api/v1/remote/tasks", true},
		{"admin", http.MethodGet, "/api/v1/remote/credentials", true},
		{"operator", http.MethodGet, "/api/v1/remote/credentials", false},
		{"viewer", http.MethodGet, "/api/v1/remote/credentials", false},
		{"operator", http.MethodPut, "/api/v1/remote/credentials/1", false},
		{"operator", http.MethodDelete, "/api/v1/remote/credentials/1", false},
		{"operator", http.MethodPut, "/api/v1/assets/3", true},
		{"operator", http.MethodPost, "/api/v1/edr/findings", true},
		{"operator", http.MethodPost, "/api/v1/edr/findings/3/ack", true},
		{"operator", http.MethodPost, "/api/v1/edr/findings/3/ignore", true},
		{"operator", http.MethodPost, "/api/v1/edr/findings/3/resolve", true},
		{"viewer", http.MethodPost, "/api/v1/edr/findings", false},
		{"viewer", http.MethodGet, "/api/v1/edr/findings", true},
		{"viewer", http.MethodGet, "/api/v1/edr/findings/3", true},
		{"operator", http.MethodPost, "/api/v1/patch-tasks/1/verify", true},
		{"viewer", http.MethodPost, "/api/v1/patch-tasks/1/verify", false},
